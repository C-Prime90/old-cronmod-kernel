...
#define SRC_SCPLL	1 /* output of scpll 176-1220 MHZ */
...
struct clkctl_acpu_speed acpu_freq_tbl[] = {
  ...
  { 844800, CCTL(CLK_TCXO, 1),		SRC_SCPLL, 0x10, 0, 1250, 128000 , 0 },
  { 921600, CCTL(CLK_TCXO, 1),		SRC_SCPLL, 0x11, 0, 1275, 128000 , 0 },
  { 998400, CCTL(CLK_TCXO, 1),		SRC_SCPLL, 0x12, 0, 1275, 128000 , 0 },
  { 1036800, CCTL(CLK_TCXO, 1), 	SRC_SCPLL, 0x13, 0, 1275, 128000 , 0 },
  { 1075200, CCTL(CLK_TCXO, 1), 	SRC_SCPLL, 0x14, 0, 1275, 128000 , 0 },
  { 1113600, CCTL(CLK_TCXO, 1), 	SRC_SCPLL, 0x15, 0, 1275, 128000 , 0 },
  { 1152000, CCTL(CLK_TCXO, 1), 	SRC_SCPLL, 0x16, 0, 1300, 128000 , 0 }, 
  { 1200000, CCTL(CLK_TCXO, 1), 	SRC_SCPLL, 0x17, 0, 1300, 128000 , 0 },
  { 1210000, CCTL(CLK_TCXO, 1), 	SRC_SCPLL, 0x18, 0, 1300, 128000 , 0 },
  { 1220000, CCTL(CLK_TCXO, 1), 	SRC_SCPLL, 0x1A, 0, 1300, 128000 , 0 },
  { 0 },
};
